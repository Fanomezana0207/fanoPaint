...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Peinture::class, mappedBy="artist", orphanRemoval=true)
     */
    private $oeuvres;
    ...
    public function addOeuvre(Peinture $oeuvre): self
    {
    ...
    public function removeOeuvre(Peinture $oeuvre): self
    {
